...
#define PWR_REGULATOR_VOLT_HIGHEST   PWR_REGULATOR_VOLTAGE_SCALE1 // See system.c

// The STM32G0xx HAL does not define this mask:
#define FLASH_FLAG_ALL_ERRORS       (FLASH_SR_ERRORS | FLASH_ECCR_ECCC)

#define USE_USB_DOUBLE_BUFFER        1

// Stupidly the HAL files for the G0 serie use several totally different names for structs and constants than the G4 serie.
// Here the STM32G0xx defines are converted into the STM32G4xx defines that are used in the firmware.
#define USB_Instance                 USB_DRD_FS
#define USB_PMA_SIZE                 USB_DRD_PMA_SIZE
#define USB_TypeDef                  USB_DRD_TypeDef
#define USB_LP_IRQn                  USB_UCPD1_2_IRQn

// Timer 16 and FDCAN line 0 share the same interrupt on this processor.
#define FDCAN1_IT0_IRQn              TIM16_FDCAN_IT0_IRQn 

// Set reset level threshold to 2.8 Volt
#define OB_BOR_LEVEL_4              (OB_BOR_LEVEL_RISING_3   | OB_BOR_LEVEL_FALLING_3) 
#define FLASH_OPTR_BOR_LEV_Msk      (FLASH_OPTR_BORR_LEV_Msk | FLASH_OPTR_BORF_LEV_Msk)

// The opposite polarity of this bit is respected in the opposite definitions of OB_BOOT0_FROM_PIN and OB_BOOT0_FROM_OB
#define OB_USER_nSWBOOT0             OB_USER_nBOOT_SEL 
#define FLASH_OPTR_nSWBOOT0_Msk      FLASH_OPTR_nBOOT_SEL_Msk
