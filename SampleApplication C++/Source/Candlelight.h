...
private:
    ...
    __int64                  ms64_WinTimeStart; // timestamp from Windows
    DWORD                    mu32_McuTimeStart; // timestamp from STM32 processor   
